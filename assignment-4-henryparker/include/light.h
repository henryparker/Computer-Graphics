...
class Light {
 public:
  ...
  virtual float pdf(const Interaction &interaction, Vec3f pos = Vec3f(0, 0, 0)) = 0;
  ...
  [[nodiscard]] virtual Vec3f getColor() {return radiance;}
...
class SquareAreaLight : public Light {
 public:
  ...
  float pdf(const Interaction &interaction, Vec3f pos = Vec3f(0, 0, 0)) override;
